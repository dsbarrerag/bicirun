...
class ReferencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reference" do
    assert_difference('Reference.count') do
      post references_url, params: { reference: { adress: @reference.adress, email: @reference.email, first_name: @reference.first_name, last_name: @reference.last_name, phone: @reference.phone } }
    end
  ...
  test "should update reference" do
    patch reference_url(@reference), params: { reference: { adress: @reference.adress, email: @reference.email, first_name: @reference.first_name, last_name: @reference.last_name, phone: @reference.phone } }
